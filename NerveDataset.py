...
class NerveDataset:
  ...
  def create(self, image_data_path, mask_data_path, has_mask=True, debug=False):
    ...
    #X = np.zeros((num_images, self.IMG_HEIGHT, self.IMG_WIDTH, 1), dtype=np.uint8)
...
if __name__ == "__main__":
  try:
    ...
    train_image_datapath = "./Nerve/train/images/"
    train_mask_datapath  = "./Nerve/train/masks/"
    test_image_datapath  = "./Nerve/valid/images/"
    test_mask_datapath   = "./Nerve/valid/masks/"

    dataset = NerveDataset(resized_image)
